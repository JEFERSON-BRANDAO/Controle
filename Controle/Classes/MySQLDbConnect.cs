    ...
    public class MySQLDbConnect
    {
        ...
        public bool Conectar()
        {
            try
            {
                ...
                string IP_SERVER = Controle.Properties.Settings.Default.IpServer;
                string USUARIO_DATABASE = Controle.Properties.Settings.Default.usuarioDB;
                string SENHA_DATABASE = Controle.Properties.Settings.Default.senhaDB;
                string NOME_DATABASE = Controle.Properties.Settings.Default.dataSourceDB;

                //
                Criptografia objCriptografia = new Criptografia();
                string _connectionString = "server=" + IP_SERVER + ";uid=" + objCriptografia.Descriptografar(USUARIO_DATABASE) + ";pwd=" + objCriptografia.Descriptografar(SENHA_DATABASE) + ";database=" + objCriptografia.Descriptografar(NOME_DATABASE);
        ...
        public void AdicionarParametro(string nome, object valor, MySqlDbType tipo)
        {
        ...
        public void AdicionarParametroSaida(string nome, MySqlDbType tipo)
        {
            MySqlParameter parametro = new MySqlParameter(nome, tipo);
